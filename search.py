...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print("Nodos Visitados: %s" % (visitados + 1))
            return node
...
def priority_graph_search(problem):
    return graph_search(problem, PriorityQueue())

def priority_heu_graph_search(problem):
    return graph_search(problem, PriorityHeurQueue(problem))
